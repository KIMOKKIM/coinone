# -*- coding: utf-8 -*-
\"\"\"Run backtest for the recent N days (default 30 days).

Usage:
    python .\\run_backtest_month.py

The result CSV will be saved under config.DATA_DIR with a timestamped filename.
\"\"\"
...
def main():
    ...
    print('Backtest period: last %d days, timeframe=%s, bars_needed=%d' % (days, tf, bars_needed))
